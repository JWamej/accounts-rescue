...
if __name__ == '__main__':
    ...
    # This seems completely illogical (and most probably is), but this is the only walk-aroud I could have found to
    # basically create the equivalence of a circular import. This voodoo works only because the MainWindow.__init__
    # saves these objects as a variable, but doesn't use them.
